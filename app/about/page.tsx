        ...
        <section className="bg-[#001a3d] text-white py-24 px-6 lg:px-12">
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16">
            ...
            <div className="space-y-6">
              ...
              <p className="text-xl font-medium text-gray-300 leading-relaxed">
                Africa where every household and school has access to affordable, clean cooking energy, waste is fully valorized, and communities thrive in a circular, climate-resilient economy.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-5xl mx-auto px-6 lg:px-12">
            ...
            <div className="prose prose-xl max-w-none montserrat font-medium text-gray-700 space-y-12 leading-relaxed">
              ...
              <div className="space-y-8">
                <p>
                 Witnessing women trek miles for firewood only to cook in toxic smoke while waste 
                 dumpsites reached breaking point sparked our mission. Through continuous research, and product
                  development, leveraging waste that was also a burden, we realized that organic waste is a buried cooki
                  ng energy source. By bridging the gap between waste management and affordable cooking energy through 
                   Biodigester installations and cylinder stored biogas, we are turning cooking energy crisis and organic 
                   waste burden into a circular economy that empowers families.
