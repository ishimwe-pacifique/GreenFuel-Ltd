...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-green-50/30 to-emerald-50/20">
      <Header />
      <PageBanner
        title="About Green Fuel Ltd"
        subtitle="A Rwandan social enterprise dedicated to providing clean, sustainable energy solutions"
        backgroundImage="/biogas-plant-with-green-energy-infrastructure-in-r.jpg"
      />
      ...
      <main className="pb-20 relative overflow-hidden">
              ...
              <Card className="group border-0 bg-white/80 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden relative">
                ...
                <CardContent className="p-10 relative z-10">
                  <div className="flex items-center mb-8">
                    ...
                    <h2 className="text-3xl lg:text-4xl font-bold text-gray-800 group-hover:text-green-700 transition-colors duration-300">Our Vision</h2>
                  </div>
              ...
              <Card className="group border-0 bg-white/80 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden relative">
                ...
                <CardContent className="p-10 relative z-10">
                  <div className="flex items-center mb-8">
                    ...
                    <h2 className="text-3xl lg:text-4xl font-bold text-gray-800 group-hover:text-emerald-700 transition-colors duration-300">Our Mission</h2>
                  </div>
                  <p className="text-lg text-gray-600 leading-relaxed font-medium">
        ...
        <section className="py-20 bg-gradient-to-r from-green-50/50 via-emerald-50/50 to-teal-50/50 backdrop-blur-sm relative z-10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-green-700 via-emerald-600 to-teal-600 bg-clip-text text-transparent mb-6">Why Bio-Energy?</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8 lg:gap-10">
              <Card className="group text-center border-0 bg-white/90 backdrop-blur-sm shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 overflow-hidden relative">
                ...
                <CardContent className="p-8 lg:p-10 relative z-10">
                  ...
                  <h3 className="text-2xl font-bold text-gray-800 mb-6 group-hover:text-green-700 transition-colors duration-300">Environmental Impact</h3>
              ...
              <Card className="group text-center border-0 bg-white/90 backdrop-blur-sm shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 overflow-hidden relative">
                ...
                <CardContent className="p-8 lg:p-10 relative z-10">
                  ...
                  <h3 className="text-2xl font-bold text-gray-800 mb-6 group-hover:text-emerald-700 transition-colors duration-300">Community Benefits</h3>
                  <p className="text-gray-600 leading-relaxed font-medium">
              ...
              <Card className="group text-center border-0 bg-white/90 backdrop-blur-sm shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 overflow-hidden relative">
                ...
                <CardContent className="p-8 lg:p-10 relative z-10">
                  ...
                  <h3 className="text-2xl font-bold text-gray-800 mb-6 group-hover:text-teal-700 transition-colors duration-300">Innovation</h3>
                  <p className="text-gray-600 leading-relaxed font-medium">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-16">
                ...
                <h2 className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-green-700 via-emerald-600 to-teal-600 bg-clip-text text-transparent mb-6">Our Story</h2>
                ...
                <CardContent className="p-10 lg:p-16">
                  <div className="prose prose-lg max-w-none text-gray-600 space-y-8">
                    <p className="text-xl leading-relaxed font-medium first-letter:text-6xl first-letter:font-bold first-letter:text-green-600 first-letter:float-left first-letter:mr-3 first-letter:mt-1">
                      Green Fuel Ltd was founded with a simple yet powerful vision: to transform the way Africa generates
                      and consumes energy. Born from the recognition that traditional energy sources are both
                      environmentally harmful and economically unsustainable for many communities, we set out to create a
                      better solution.
                    </p>

                    <div className="border-l-4 border-green-500 pl-6 bg-green-50/50 py-4 rounded-r-lg">
                      <p className="text-lg leading-relaxed font-medium">
                        Our journey began in Rwanda, where we witnessed firsthand the challenges faced by households and
                        institutions in accessing clean, affordable energy. Through extensive research and development, we
                        developed innovative bio-digester systems that convert organic waste into clean biogas and valuable
                        fertilizer.
                      </p>
                    </div>

                    <p className="text-lg leading-relaxed font-medium">
                      Today, we continue to expand our impact across the region, helping communities achieve energy
                      independence while protecting the environment. Every installation represents not just a technological
                      solution, but a step toward a more sustainable and prosperous future for all.
                    </p>
                  </div>
